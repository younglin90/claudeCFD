#!/usr/bin/env python3
"""Phase 1 Abgrall test — 5-equation conservative AD Newton."""
import sys, os
...
case = {
    'ph1': ph_water, 'ph2': ph_air,
    'x_cells': x_cells,
    'psi_init': psi_init,
    'p_init': p_init, 'u_init': u_init, 'T_init': T_init,
    't_end': 1.0, 'CFL': 0.5,
    'bc_left': 'periodic', 'bc_right': 'periodic',
    'max_iteration': 10,
    'five_eq_cons_ad': True,
    'use_autograd': True,
    'max_newton': 30,
    'newton_tol': 1e-8,
    'max_outer': 3,

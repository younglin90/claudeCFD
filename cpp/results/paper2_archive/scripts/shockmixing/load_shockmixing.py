# -*- coding: utf-8 -*-
"""Load the paper2 shock / mixing-layer dumps and resample onto a uniform grid."""
import numpy as np, os
import matplotlib.tri as mtri

R = os.path.join(RESULTS, "paper2_3_data", "shockmixing")
import os
...
np.savez_compressed(os.path.join(S, "sm_grid.npz"), **out)
print("\ncached -> sm_grid.npz")

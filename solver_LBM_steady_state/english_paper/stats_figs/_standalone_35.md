# Aggregate Performance and Solution Agreement of MSA-LBM

*Section 3.5 of the manuscript, presented separately. Figure numbers (7–9) and reference numbers ([38], [43]) follow the full paper.*
...
[38] Ghia, U., Ghia, K. N., & Shin, C. T. (1982). High-Re solutions for incompressible flow using the Navier–Stokes equations and a multigrid method. *Journal of Computational Physics*, 48(3), 387–411. https://doi.org/10.1016/0021-9991(82)90058-4

[43] Dolan, E. D., & Moré, J. J. (2002). Benchmarking optimization software with performance profiles. *Mathematical Programming*, 91(2), 201–213. https://doi.org/10.1007/s101070100263

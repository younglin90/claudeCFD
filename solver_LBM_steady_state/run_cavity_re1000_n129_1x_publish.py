#!/usr/bin/env python3
"""Run lid-driven cavity Re=1000, N=129 (1x) and export paper-ready artifacts.

This is a thin wrapper around the existing cavity production runner.
It rebinds the case parameters to Re=1000 / N=129 while preserving the same
artifact protocol:
...
def configure():
    base.CASE_ID = "cavity_re1000_n129"
    base.CASE_LABEL = "Lid-driven cavity Re=1000 N=129"
    base.RE = 1000
    base.N = 129
    base.U_WALL = 0.1
    base.TOL = 5e-7

    base.OUT_ROOT = Path("papers_data") / "lid_driven_Re1000_N129__1x"

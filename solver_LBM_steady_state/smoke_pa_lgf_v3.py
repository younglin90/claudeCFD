...
from solver_novel5 import solve_pa_lgf_v3
...
def main():
    for cid, N, kind in CASES:
        ...
        f, hist = solve_pa_lgf_v3(case, max_outer=4000, vchg_tol=1e-6,
                                    residual_tol=1e-10, anderson_m=10,
                                    alpha=1.0, K_relax_after=2,
                                    check_vchg_every=50, verbose=False)
        ...
        print(f"  PA-LGF-v3 {cid:18s} accel={accel:>6d} tail={tail:>6d} total={total:>7d} "

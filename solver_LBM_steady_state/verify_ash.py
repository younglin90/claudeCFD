...
from solver_ash import solve_ash
...
def run_case(case_b, case_s, tol, baseline_runner, scmk_kw,
    ...
    t0 = time.perf_counter()
    f_s, hist_s = solve_ash(case_s, tol=tol, verbose=False, **scmk_kw)
...
scmk_kw = dict(max_outer=200, krylov_max=10, krylov_tol=1e-3, kinetic_substeps=15)

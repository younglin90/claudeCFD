...
from solver_gsis import solve_gsis
...
def run_case(case_b, case_s, tol, baseline_runner, scmk_kw,
    ...
    t0 = time.perf_counter()
    f_s, hist_s = solve_gsis(case_s, tol=tol, verbose=False, **scmk_kw)
...
scmk_kw = dict(max_outer=200, ho_substeps=8, kinetic_substeps=5)

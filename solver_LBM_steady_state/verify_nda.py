...
from solver_nda import solve_nda
...
def run_case(case_b, case_s, tol, baseline_runner, scmk_kw,
    ...
    t0 = time.perf_counter()
    f_s, hist_s = solve_nda(case_s, tol=tol, verbose=False, **scmk_kw)
...
scmk_kw = dict(max_outer=200, ho_substeps=8, kinetic_substeps=5, alpha=0.5, relax=0.3)

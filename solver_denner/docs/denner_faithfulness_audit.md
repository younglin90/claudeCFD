...
| 24 §7.4.1 | EOS ✅ (already SG water). **CFL 0.10→0.5**, sweep ψ∈{0,.25,.5,.75,1} (now only 0.5). RH ref uses Kapila/Wood not Denner Eq.59-62. | P1/P2 |
...
exact will match Denner once the ICs/geometry are aligned. 24 still uses Kapila/Wood RH
(should be Denner Eq.59-62 interface-region RH). 14/15 = project (NASG / self-convergence).

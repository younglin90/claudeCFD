...
# ═══════════════════════════════════════════════════════════════════
# MANY-FLUX SECTION (Wang, Wehrfritz, Hawkes JCP 2025)
# Split-convective flux formulations: KGP, KEEP, KEEPPE, etc.
# ═══════════════════════════════════════════════════════════════════
"""
...
# ═══════════════════════════════════════════════════════════════════
# CPG EULER REFERENCE SECTION
# Generic 1D multi-component Calorically Perfect Gas Euler FVM
# ═══════════════════════════════════════════════════════════════════
"""
cpg_euler_1d.py
================
...
def cfl_dt_euler(Q, gs, ws, dx, CFL):
    u   = Q[:, 1] / Q[:, 0]
...
def run_euler(Q0, gs, ws, dx, CFL, T_end, bc='transmissive',
    ...
    for step in range(max_steps):
        if t >= T_end:
            break
        dt = min(cfl_dt_euler(Q, gs, ws, dx, CFL), T_end - t)
        if dt <= 1e-15:
            break
